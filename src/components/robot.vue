    ...
    <div class="indexBoxInner rela">
      ...
      <div class="mainWrapper clearfix">
          ...
          <div v-show="vshowFlag" class="leftMain fl" :class="{ 'animate__animated animate__slideInLeft':openStatus, 'animate__animated animate__fadeInLeft':closeStatus }">
            ...
            <!--每一个机器人-->
            <div class="energyStatistic bdbox commonTitlebox comBoderAndBg pureSetBG" style="width:520px;height:298px;background:#283353;border:none;margin-top:0!important;">
                ...
                <div class="robotMain">
                  <div class="robotMainT clearfix">
                    ...
                    <div class="robotMainTR fr bdbox pureSetBGUpper">
            ...
            <!--每一个机器人-->
            <div class="energyStatistic bdbox commonTitlebox comBoderAndBg pureSetBG" style="width:520px;height:298px;border:none;background:#283353;">
                <div class="main1 flex-row" style="width:545px;">
                  <div class="mod1 flex-col"></div>
                  <!-- <span class="txt1">能耗态势</span> -->
                  <img style="width:50px;height:23px;margin-top:5px;margin-left:10px;" src="../assets/keBG.png">
                      ...
                      <div class="robotMainTRt">
                        <div class="robotMainTRt-a clearfix">
                          <div class="robotMainTRt-a-l fl">
                            ...
                            <div class="sseip">
                              <el-switch style="margin-left:16px;" v-model="valueRobot2" active-color="#00CCFFFF" inactive-color="#ff4949"></el-switch>
                            </div>
                          </div>
                          <div class="robotMainTRt-a-r fr">
                            <p class="rela">
                      ...
                      <div class="robotMainTRt">
                        <div class="robotMainTRt-a clearfix">
                          <div class="robotMainTRt-a-l fl">
                            ...
                            <div class="sseip">
                              <el-switch style="margin-left:16px;" v-model="valueRobot3" active-color="#00CCFFFF" inactive-color="#ff4949"></el-switch>
                            </div>
                          </div>
                          <div class="robotMainTRt-a-r fr">
                            <p class="rela">
          ...
          <div v-show="vshowFlag" class="rightMain fr" :class="{ 'animate__animated animate__slideInRight':openStatus, 'animate__animated animate__fadeInRight':closeStatus }">
              ...
              <!--每一个机器人-->
            <div class="energyStatistic bdbox commonTitlebox comBoderAndBg fr pureSetBG" style="width:520px;height:298px;border:none;background:#283353;margin-top:0!important;">
                <div class="main1 flex-row" style="width:545px;">
                  <div class="mod1 flex-col"></div>
                  <!-- <span class="txt1">能耗态势</span> -->
                  <img style="width:50px;height:23px;margin-top:5px;margin-left:10px;" src="../assets/keBG.png">
                      ...
                      <div class="robotMainTRt">
                        <div class="robotMainTRt-a clearfix">
                          <div class="robotMainTRt-a-l fl">
                            ...
                            <div class="sseip">
                              <el-switch style="margin-left:16px;" v-model="valueRobot4" active-color="#00CCFFFF" inactive-color="#ff4949"></el-switch>
                            </div>
                          </div>
                          <div class="robotMainTRt-a-r fr">
                            <p class="rela">
            ...
            <!--每一个机器人-->
            <div class="energyStatistic bdbox commonTitlebox comBoderAndBg fr pureSetBG" style="width:520px;height:298px;border:none;background:#283353;">
                <div class="main1 flex-row" style="width:545px;">
                  <div class="mod1 flex-col"></div>
                  <!-- <span class="txt1">能耗态势</span> -->
                  <img style="width:50px;height:23px;margin-top:5px;margin-left:10px;" src="../assets/keBG.png">
                      ...
                      <div class="robotMainTRt">
                        <div class="robotMainTRt-a clearfix">
                          <div class="robotMainTRt-a-l fl">
                            ...
                            <div class="sseip">
                              <el-switch style="margin-left:16px;" v-model="valueRobot5" active-color="#00CCFFFF" inactive-color="#ff4949"></el-switch>
                            </div>
                          </div>
                          <div class="robotMainTRt-a-r fr">
                            <p class="rela">
                      ...
                      <div class="robotMainTRt">
                        <div class="robotMainTRt-a clearfix">
                          <div class="robotMainTRt-a-l fl">
                            ...
                            <div class="sseip">
                              <el-switch style="margin-left:16px;" v-model="valueRobot6" active-color="#00CCFFFF" inactive-color="#ff4949"></el-switch>
                            </div>
                          </div>
                          <div class="robotMainTRt-a-r fr">
                            <p class="rela">
...
.robotMainB{
  width:490px;height:43px;background:#1f2942;margin-left:10px;margin-top:6px;
}
.robotMainB span{
  color: #fff;
  font-size: 14px;
