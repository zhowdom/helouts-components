    ...
    <div class="indexBoxInner rela">
      ...
      <div class="mainWrapper clearfix">
          ...
          <div v-show="vshowFlag" class="leftMain fl" :class="{ 'animate__animated animate__slideInLeft':openStatus, 'animate__animated animate__fadeInLeft':closeStatus }">
            ...
            <!--5-->
            <div class="energyStatistic bdbox commonTitlebox comBoderAndBg rela" style="width:520px;height:220px;border: none;margin-top:0!important;">
                ...
                <div id="echrMain3Pie3" style="width: 420px;height: 165px;"></div>
            </div>

            <!--4-->
            <div class="energyStatistic bdbox commonTitlebox comBoderAndBg" style="width:520px;height:217px;">
                <div class="main1 flex-row" style="width:504px;">
                  <div class="mod1 flex-col"></div>
                ...
                <div class="linerStyle" style="margin-top:5px;margin-left:16px;width:484px;"></div>
                <div id="echrMain" style="width: 490px;height: 162px;"></div>
            </div>
            ...
            <!--5-->
            <div class="energyStatistic bdbox commonTitlebox comBoderAndBg" style="width:520px;height:213px;">
          ...
          <div v-show="vshowFlag" class="rightMain fr" :class="{ 'animate__animated animate__slideInRight':openStatus, 'animate__animated animate__fadeInRight':closeStatus }">
            ...
            <!--来访统计-->
            <div class="visitStatistic bdbox commonTitlebox comBoderAndBg fr nblast" style="height:915px;border:none;margin-top:0!important;">
              ...
              <div class="clearfix" style="margin-bottom:10px;"></div>
                  ...
                  <div class="llastbox fl" style="margin-bottom:10px;">
                    <h3>校准设备</h3>
                    <ul v-if="indexData.calibrationList" style="height:244px;overflow-y: scroll;overflow-x: hidden;">
                  ...
                  <div class="llastbox fl">
                    <h3>期间核准设备</h3>
                    <ul style="height:278px;overflow-y: scroll;overflow-x: hidden;">
...
export default {
  ...
  methods: {
    ...
    showdidialog (code) {
      ...
      // window.ue.web.js_call_ue("仪器设备弹窗", id)
    ...
    handleCloseEirn () {
      ...
      window.ue.web.js_call_ue("仪器设备弹窗关闭", 'null')
    },
    myEchartsNanding () {
      // 通过id获取获取画布
