  ...
  <div class="eachCardBox clearfix">
    <div class="energyStatistic bdbox commonTitlebox comBoderAndBg rela" style="width:520px;height:213px;border: none;">
      ...
      <div class="sp3Btns abs">
        <el-tabs v-model="activeName" @tab-click="handleClickGas">
      ...
      <div v-show="showDayPieGas" id="echrMain3PieDay" style="width: 420px;height: 158px;"></div>
      <div v-show="showMonthPieGas" id="echrMain3PieMonth" style="width: 420px;height: 158px;"></div>
      <div v-show="showYearPieGas" id="echrMain3PieYear" style="width: 420px;height: 158px;"></div>
  </div>
...
export default {
  ...
  data () {
    return {
      ...
      activeName: 'day',
      showDayPieGas: true,
      showMonthPieGas:false,
      showYearPieGas:false,
    }
  },
  async mounted () {
  ...
  methods: {
    ...
    handleClickGas (tab) {
      switch (tab.name) {
        case 'day':
          this.showDayPieGas = true
          this.showMonthPieGas = false
          this.showYearPieGas = false
          break;
        case 'month':
          this.showDayPieGas = false
          this.showMonthPieGas = true
          this.showYearPieGas = false
    ...
    myEcharts3PieDay () {
      var myChart = echarts.init(document.getElementById('echrMain3PieDay'))
    ...
    myEcharts3Pie3Month () {
      var myChart = echarts.init(document.getElementById('echrMain3PieMonth'))
    ...
    myEcharts3Pie3Year () {
      var myChart = echarts.init(document.getElementById('echrMain3PieYear'))
