  ...
  <div class="eachCardBox clearfix">
    <div class="energyStatistic bdbox commonTitlebox comBoderAndBg" style="width:520px;height:220px;">
          <div class="main1 flex-row" style="width:545px;">
            ...
            <span class="word1" style="margin-left:58px;">{{cardSubTitle}}</span>
          ...
          <div v-if="cardData.length" class="mabboxT-l-topBT mabboxT-l-topBT_v2" style="padding-left:16px;">
            <p v-for="(item, index) in cardData" :key="index" class="clearfix" style="margin-bottom:7px;">
