              ...
              <div class="visitStatistic-main clearfix">
                <div class="vs-ml fl">
                  <div class="esmallbox clearfix rela" style="margin-top:11px;">
                    <div class="esmall fl">
                      <div class="estitle">今日来访者</div>
                      <div class="esvalue txtc rela" style="font-size:20px;">{{cardData.todayVisit}}</div>
                    </div>
                    <div class="esmall fr">
                      <div class="estitle">今日来预约</div>
                      <div class="esvalue txtc rela" style="font-size:20px;">{{cardData.todayReserve}}</div>
                    </div>

                    <div class="abs secTop1">
                      <p>昨日来访：{{cardData.lastDayVisit}}</p>
                      <p>昨日预约：{{cardData.lastDayReserve}}</p>
                    </div>
                  </div>
                  <div class="emainbox clearfix" style="margin-top:15px;">
                    <div class="emain fl">
                      <div class="emtitle">本周</div>
                      <div class="emvalue txtc" style="font-size:17px;">{{cardData.thisWeekVisit}}</div>
                      <div class="embooking txtc">预约：{{cardData.thisWeekReserve}}位</div>
                    </div>
                    <div class="emain fl">
                      <div class="emtitle">本月</div>
                      <div class="emvalue txtc" style="font-size:17px;">{{cardData.thisMonthVisit}}</div>
                      <div class="embooking txtc">预约：{{cardData.thisMonthReserve}}位</div>
                    </div>
                    <div class="emain fl">
                      <div class="emtitle">本年</div>
                      <div class="emvalue txtc" style="font-size:17px;">{{cardData.thisYearVisit}}</div>
                      <div class="embooking txtc">预约：{{cardData.thisYearReserve}}位</div>
                    </div>

                  </div>
                  
                </div>
                <div class="vs-mr fr rela" style="margin-top:20px;">
                  <div class="aboveRings abs"></div>
                  <span class="vsmrname abs">来访率</span>
