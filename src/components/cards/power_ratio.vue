<template>
  <div class="eachCardBox clearfix">
    <div class="energyStatistic bdbox commonTitlebox comBoderAndBg rela" style="width:520px;height:213px;border: none;">
      ...
      <div v-show="showDayPieElect" id="echrMain3Pie3Day" style="width: 420px;height: 158px;"></div>
      <div v-show="showMonthPieElect" id="echrMain3Pie3Month" style="width: 420px;height: 158px;"></div>
      <div v-show="showYearPieElect" id="echrMain3Pie3Year" style="width: 420px;height: 158px;"></div>
  </div>
  </div>
</template>
...
export default {
  ...
  data () {
    return {
      ...
      activeName3: 'day',
      showDayPieElect: true,
      showMonthPieElect:false,
      showYearPieElect:false,
    }
  },
  async mounted () {
  ...
  methods: {
    ...
    handleClick3 (tab) {
      switch (tab.name) {
        case 'day':
          this.showDayPieElect = true
          this.showMonthPieElect = false
          this.showYearPieElect = false
          // this.myEcharts3Pie3Day()
          break;
        case 'month':
          this.showDayPieElect = false
          this.showMonthPieElect = true
          this.showYearPieElect = false
    ...
    myEcharts3Pie3Day () {
      var myChart = echarts.init(document.getElementById('echrMain3Pie3Day'))
    ...
    myEcharts3Pie3Month () {
      var myChart = echarts.init(document.getElementById('echrMain3Pie3Month'))
    ...
    myEcharts3Pie3Year () {
      var myChart = echarts.init(document.getElementById('echrMain3Pie3Year'))
