<template>
  <div class="eachCardBox clearfix">
    <div class="visitStatistic bdbox commonTitlebox comBoderAndBg" style="margin-top:0!important;height:210px;">
              ...
              <div class="visitStatistic-main clearfix">
                <div v-if="cardData" class="vs-ml fl" style="width:340px;">
                  <div class="esmallbox clearfix rela" style="margin-top:11px;margin-left:15px;">
                    <div class="esmall fl">
                      <div class="estitle">设备总数</div>
                      <div class="esvalue txtc rela">{{cardData.totalCount}}</div>
                    </div>
                    <div class="esmall fr">
                      <div class="estitle">运行设备数</div>
                      <div class="esvalue txtc rela">{{cardData.runingCount}}</div>
                    </div>
                  ...
                  <div class="emainbox clearfix" style="margin-top:15px;margin-left:15px;">
                    <div class="esmall fl">
                      ...
                      <div class="esvalue txtc rela">{{cardData.failureCount}}</div>
                    </div>
                ...
                <div class="vs-mr fr rela" style="margin-right:10px;">
                  ...
                  <span v-if="cardData" class="vsmrname abs percentVALUES" style="bottom:45px!important;"><i>{{(Number(cardData.runningRate.replace('%', ''))).toFixed(0)}}</i><sub>%</sub></span>
...
export default {
  ...
  methods: {
    ...
    myEchartsBing () {
      ...
      // 指定图表的配置项和数据
      let data = +(this.cardData && this.cardData.runningRate).replace('%', '');
      let option = {
        title: {
          text:'',//主标题文本
          subtext:'',//副标题文本
